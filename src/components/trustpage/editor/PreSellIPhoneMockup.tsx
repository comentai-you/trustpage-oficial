...
const PreSellIPhoneMockup = ({ content, ownerPlan, size = "normal" }: PreSellIPhoneMockupProps) => {
  ...
  const backgroundColor =
    content.backgroundType === "gradient" ? content.gradientStart : content.backgroundColor;
  ...
  return (
    <div className="relative shrink-0">
      ...
      <div
        ...
        style={{
          boxShadow:
            "0 30px 60px -15px rgba(0, 0, 0, 0.5), 0 0 0 1px rgba(255,255,255,0.1) inset",
        }}
      >
        {/* Side buttons */}
        ...
        >
          ...
          >
            <style>
              {`.iphone-presell-scroll::-webkit-scrollbar { display: none; }`}
            </style>
